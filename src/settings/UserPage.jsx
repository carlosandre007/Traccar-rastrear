    ...
    >
      {item && (
        <>
          ...
          {/* NOVO ACORDEÃO PARA DADOS PESSOAIS */}
          <Accordion>
            <AccordionSummary expandIcon={<ExpandMoreIcon />}>
              <Typography variant="subtitle1">
                {t('personalDataTitle')} {/* Nova chave de tradução para o título */}
              </Typography>
            </AccordionSummary>
            <AccordionDetails className={classes.details}>
              <TextField
                value={item.attributes?.fullName || ''}
              ...
              />
              <TextField
                value={item.attributes?.whatsapp || ''}
                onChange={(e) => setItem(prevItem => ({
                  ...prevItem,
                  attributes: {
                    ...prevItem.attributes,
                ...
                label={t('userWhatsapp')}
              />
            </AccordionDetails>
          </Accordion>
          {/* FIM DO NOVO ACORDEÃO PARA DADOS PESSOAIS */}
