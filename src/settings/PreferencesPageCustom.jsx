...
const PreferencesPageCustom = ({ open, setOpen }) => {
  ...
  const styles = {
    ...
    column: {
      flex: "1 1 350px", // Cresce, encolhe, com base mínima de 350px
      minWidth: "350px",
      maxWidth: "100%",
      borderRadius: "10px",
      // padding: "20px",
...
{/*           <Tab label="Token" />
                            ...
                            {mapStyles.map((style) => (
                              <MenuItem key={style.id} value={style.id}>
                                <Typography
                                  component="span"
                                  color={
                                    style.available ? "textPrimary" : "error"
                                  }
                                >
                                  {style.title}
                                </Typography>
                            ...
                            {mapOverlays.map((overlay) => (
                              <MenuItem key={overlay.id} value={overlay.id}>
                                <Typography
                                  component="span"
                                  color={
                                    overlay.available ? "textPrimary" : "error"
                                  }
                                >
                                  {overlay.title}
                                </Typography>
        ...
        {tab === 1 && (
          <Box p={2}>
            {/* Conteúdo da aba "Token" */}
            <h3>Gerenciamento de Token</h3>
...
export default PreferencesPageCustom;
