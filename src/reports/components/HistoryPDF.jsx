          ...
          >
            ...
            >
              ...
              >
                ...
                <View style={styles.boxes}>
                  <Text style={styles.titles}>Ligado em Movimento</Text>

                  <Text>{dadosTempo.totalLigadoMovimento}</Text>
                </View>

                <View style={styles.boxes}>
                  <Text style={styles.titles}>Ligado e Parado</Text>

                  <Text>{dadosTempo.totalLigadoParado}</Text>
                </View>

                <View style={styles.boxes}>
                  <Text style={styles.titles}>Estacionado</Text>

                  <Text>{dadosTempo.totalDesligado}</Text>
                </View>
              </View>
            </View>

            <Card13
              columnTitle={"Velocidade"}
              value1={`${gastos.velocidadeMaxima_kmh} km/h`}
              subtitle={"Máxima"}
              value2={`${gastos.velocidadeMedia_kmh} km/h`}
              subtitle2={"Média"}
              value3={gastos.tempoExcessoVelocidade}
              subtitle3={"Excesso"}
            />
            <Card13
              columnTitle={"Distância"}
              value1={`${gastos.distanciaKm} Km`}
              subtitle={"Percurso"}
              value2={`${
                (items[items.length - 1]?.attributes?.odometer / 1000).toFixed(
                  0
                ) || 0
              } Km`}
              subtitle2={"Odômetro"}
              value3={`${gastos.mediaKmPorDia} Km`}
              subtitle3={"Média por dia"}
            />
            <Card13
              columnTitle={"Combustível"}
              value1={`${gastos.consumoEstimadoLitros}`}
              subtitle={"Litros"}
              value2={`R$ ${gastos.custoEstimadoCombustivel}`}
              subtitle2={"Gasto"}
              value3={`${gastos.mediaKmPorLitro} l/km`}
              subtitle3={"Média"}
            />
